...
TOKEN = os.getenv(8180865453:AAHC4o41bqHKGmV2-WPVAPFF6SxE2vAkx80", "8180865453:AAHC4o41bqHKGmV2-WPVAPFF6SxE2vAkx80")  # Replace with your actual token or set as env var
bot = Bot(token=TOKEN)
